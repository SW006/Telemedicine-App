...
export default function SignInPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FORCE admin routing - check email explicitly
      if (email.toLowerCase().includes('admin') || email.toLowerCase() === 'admin@teletabib.com') {
        console.log('🔧 FORCING ADMIN ROUTE - Admin email detected:', email)
        userRole = 'doctor'  // Force admin to doctor dashboard
      }
