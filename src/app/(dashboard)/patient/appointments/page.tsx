...
import patientAppointmentsData from "@/data/appointments/patient-appointments.json";
...
export default function PatientAppointments() {
  ...
  const appointments = patientAppointmentsData.appointments;
  const appointmentTypes = patientAppointmentsData.appointmentTypes;
