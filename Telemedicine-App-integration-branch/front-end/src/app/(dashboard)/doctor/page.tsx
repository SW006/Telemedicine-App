  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Admin/Doctor Dashboard</h1>
          <p className="text-gray-600 mt-1">Welcome back, Dr. Admin</p>
        </div>
