...
export default function SignUpPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Prevent multiple submissions and rapid clicks
    const now = Date.now()
    if (isLoading || (now - lastSubmissionTime.current < 2000)) {
      console.log('Registration already in progress or too soon after last attempt, ignoring duplicate request')
      return
    }
