  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        const profileData = await fetchProfileById('patient', patientId)
        if (!profileData) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">{error || 'Unable to load patient profile'}</p>
            ...
            <CardContent>
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-gray-900">{profile.medicalNotes || 'No medical notes available'}</p>
                )}
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Patient ID: {profile.id}</p>
                </div>
              </div>
          ...
          {profile.primaryDoctor && (
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600">Doctor ID: {profile.primaryDoctor}</p>
                <p className="text-xs text-gray-500 mt-1">Primary care physician assigned to this patient</p>
              </CardContent>
            </Card>
          )}
        </div>
