...
export default function DoctorSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await axios.post(`${baseUrl}/auth/doctor-signup`, {
      ...
      if (result.data.success) {
        ...
        alert("Registration successful! Welcome to TeleTabib!");
        
        // Redirect to doctor dashboard
        if (typeof window !== 'undefined') {
          window.location.href = result.data.redirectTo || '/doctor';
        }
      } else {
